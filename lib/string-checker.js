...
var harmonyEsprima = require('esprima-harmony');
 ...
 * @param {Boolean|Object} esprima a custom esprima, or a flag saying whether to use the harmony parser
 */
var StringChecker = function(verbose, esprima) {
    ...
    if (typeof esprima === 'object') {
        ...
        // true value likely means it passed from
        // the harmony flag on the CLI, so use harmony version
        this._esprima = esprima ? harmonyEsprima : defaultEsprima;
    }
};
